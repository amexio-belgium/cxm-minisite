...
const hbsptContactForm = {
  init: function (lang) {
    ...
    script.addEventListener(
      "load",
      function () {
        hbsptContactForm.initForm(lang);
      },
      false,
    );
  ...
  initForm: function (lang) {
    ...
    lang == "fr" && (formId = "e0b390be-6491-40c2-9045-33ef9ed28f96");
    lang == "nl" && (formId = "71312006-dc15-4ec1-9b49-64c2babbd2f7");
    ...
    if (hbspt) {
      hbspt.forms.create({
        ...
        onFormReady: function () {
          ...
          const formSkeleton = document.getElementById(
