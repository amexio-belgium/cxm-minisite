      ...
      {canSignUp.value ? (
        <>
          ...
          <form preventdefault:submit onSubmit$={handleSubmit}>
            <input
              class="rounded h-[50px] w-full p-4 ring-offset-2 ring-offset-black focus-visible:outline-none focus-visible:rounded focus-visible:ring-2 focus-visible:ring-tertiary"
              type="email"
              id="email"
              placeholder="Email"
