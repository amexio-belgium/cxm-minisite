...
<ProjectMetadata
    ...
    services={frontmatter.services}
    technologies={frontmatter.technologies}>
    <Image src={analytics_square} alt="" class="h-10 w-auto"/>
    <Image src={target_square} alt="" class="h-10 w-auto"/>
    <Image src={aem_square} alt="" class="h-10 w-auto"/>
    ...
    <Image src={drupal_square} alt="" class="h-10 w-auto"/>
    <Image src={kontentai_square} alt="" class="h-10 w-auto"/>
    <Image src={google} alt="" class="h-10 w-auto"/>
