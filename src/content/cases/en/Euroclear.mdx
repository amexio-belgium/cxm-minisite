...
<ProjectMetadata
    ...
    <Image src={analytics} alt="kbc" class="h-10 w-auto"/>
    <Image src={target} alt="telenet" class="h-10 w-auto"/>
    <Image src={aem} alt="mediafin" class="h-10 w-auto"/>
    ...
    <Image src={drupal} alt="kbc" class="h-8 w-auto"/>
    <Image src={kontentai} alt="telenet" class="h-10 w-auto"/>
    <Image src={google} alt="mediafin" class="h-10 w-auto"/>
...
<ProjectMetadata
    ...
    services={frontmatter.services}
    technologies={frontmatter.technologies}>
    <Image src={analytics_square} alt="kbc" class="h-10 w-auto"/>
    <Image src={target_square} alt="telenet" class="h-10 w-auto"/>
    <Image src={aem_square} alt="mediafin" class="h-10 w-auto"/>
    <Image src={angular_square} alt="" class="h-10 w-auto"/>
    <Image src={astro_square} alt="" class="h-10 w-auto"/>
    <Image src={contentsquare_square} alt="" class="h-10 w-auto"/>
    <Image src={drupal_square} alt="kbc" class="h-10 w-auto"/>
    <Image src={kontentai_square} alt="telenet" class="h-10 w-auto"/>
    <Image src={google} alt="mediafin" class="h-10 w-auto"/>
    <Image src={nextjs_square} alt="" class="h-10 w-auto"/>
    <Image src={react_square} alt="" class="h-10 w-auto"/>
    <Image src={vue_square} alt="" class="h-10 w-auto"/>
    <Image src={sanity_square} alt="" class="h-10 w-auto"/>
</ProjectMetadata>
