...
<TeaserWithImage 
    ...
    description="
    <p>Together with the OECD, we defined the plan to design and implement a revamped digital presence, based on a modern and user-friendly CMS. 4 main goals were set for the project:
    <ul>
