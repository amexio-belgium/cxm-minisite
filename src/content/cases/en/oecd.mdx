---
title: "Providing deep economic insights to European citizens, decision- and policymakers"
client: 'OECD'
...
draft: false
heroImage: '/src/assets/projects/oecd-story1.jpg'
...
<Quote
    quote="The new OECD.org website represents a transformative step forward in making critical economic data and analysis accessible to all. With improved search functionality and easy access to nearly 30,000 publications under an open license, this platform reaffirms the OECD's commitment to empowering policymakers and the public. Our new user-friendly gateway to essential knowledge supports informed decision-making helping to address global challenges."
    name='Terri Mitton'
    jobtitle="Head of Digital Visual Communications"
    profileImage='/src/assets/people/terri-mitton.jpeg'
    class="mt-40" />
