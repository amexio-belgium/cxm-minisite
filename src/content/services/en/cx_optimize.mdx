...
<TeaserWithImage 
	...
	description="
		...
		<ul>
			<li>High acquisition costs due to increased competition.</li>
			<li>Missed revenue opportunities from inadequate customer engagement.</li>
			<li>Escalating development costs resulting from misaligned product roadmaps with actual customer needs.</li>
			<li>Low customer satisfaction and loyalty, which hinders long-term growth and retention.</li>
		</ul>
	">
...
<TilesContainer 
    ...
    description="To effectively tackle these challenges, it is essential for companies to adopt a comprehensive Optimization Strategy and foster an experimentation culture. Our unique, holistic approach focuses on:">
    <SmallTile 
