...
<LayoutSection>
    <LayoutSubsection>
        ...
        <ContentText>
            <p>A new AI assistant, <b>tailored for the future</b>. This new assistant will change the workflow of experience practitioners massively. It achieves this by providing an interface for task automation, outcome simulation and journey generation. With this new tool on their belt the productivity of your marketing team can possibly skyrocket. </p>
        </ContentText>
