...
<LayoutSection>
    ...
    <ContentHeadline headlineTag="h2">Getting started with AI means a shift in Mindset</ContentHeadline>
        <ContentText>
    ...
    <LayoutSubsection imageSrc='/src/assets/images/dog-christmas-hat6.png'></LayoutSubsection>

    <ContentHeadline headlineTag="h2">Artificial Intelligence and AEM</ContentHeadline>
        <ContentText>
    ...
    <LayoutSubsection imageSrc='/src/assets/images/elf-wine.png'></LayoutSubsection>

    <ContentHeadline headlineTag="h2">Stable Diffusion</ContentHeadline>
        <ContentText>
    ...
    <ContentHeadline headlineTag="h2">Are you already experiencing the benefits of AI? </ContentHeadline>
        <ContentText>
