...
<LayoutSection>
    ...
    <ContentImage loading="lazy" class='mx-auto shadow-xl shadow-primary/20 rounded-xl overflow-hidden'
        src='/src/assets/images/blog/quick-start-guide-for-multilingual-websites-in-adobe-experience-manager/quick-start-guide-for-multilingual-websites-in-adobe-experience-manager-1---multisite-vs-multilanguage.png' 
    ...
    <ContentImage loading="lazy" class='mx-auto shadow-xl shadow-primary/20 rounded-xl overflow-hidden'
        src='/src/assets/images/blog/quick-start-guide-for-multilingual-websites-in-adobe-experience-manager/quick-start-guide-for-multilingual-websites-in-adobe-experience-manager---2---multilingual-websites-aem.png' 
    ...
    <ContentImage loading="lazy" class='mx-auto shadow-xl shadow-primary/20 rounded-xl overflow-hidden'
        src='/src/assets/images/blog/quick-start-guide-for-multilingual-websites-in-adobe-experience-manager/quick-start-guide-for-multilingual-websites-in-adobe-experience-manager---3---aem-combinationb-language-copy-live-copy.png' 
